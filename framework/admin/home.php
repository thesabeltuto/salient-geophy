...
function salient_geophy_support() {
    ...
    <div id="wm4d_nav">
        <ul>
            ...
            <li id="salient_geophy_wm4d_li1"><a href="?page=redux_options&tab=0">Salient Geophy</a></li>
            <li id="salient_geophy_wm4d_li2"><a href="?page=wm4d_options">WM4D Options</a></li>
            <li id="salient_geophy_wm4d_li2"><a href="nav-menus.php">Menu</a></li>
            <li id="salient_geophy_wm4d_li2"><a href="?page=layerslider">Slider</a></li>
       </ul>
    </div>
    
    <div class="content" id="theme_support">
    <h2>WM4D Shortcodes Inside Salient Shortcodes Support</h2>
    <hr />
    ...
    <div class="salient_geophy_wm4d_section support">
    <table border="0" cellspacing="0" cellpadding="8" class="salient_geophy_wm4d_table_support">
        <thead>
            <th>Name</th>
            <th>Code</th>
            <th>Allowed In</th>
    ...
    <h3>Salient Page: Boxes Shortcodes</h3>
    <hr />
   ...
   <div class="salient_geophy_wm4d_section support">
    ...
    <h3>Salient Page: Appointment Shortcodes</h3>
    <hr />
    ...
    <h3>Salient Page: Lists Shortcodes</h3>
    <hr />
    <div class="salient_geophy_wm4d_section support">
    <table border="0" cellspacing="0" cellpadding="8" class="salient_geophy_wm4d_table_support">
        <thead>
    ...
    <h3>Salient Page: Space and Divisions Shortcodes</h3>
    <hr />
    <div class="salient_geophy_wm4d_section support">
    <table border="0" cellspacing="0" cellpadding="8" class="salient_geophy_wm4d_table_support">
        <thead>
    ...
    <hr />
	<p>Custom Field ID: <strong>layerslider</strong><br/>
		Custom Field Value: <strong>[layerslider id="#"]</strong></p>
    <div class="salient_geophy_wm4d_section support">
    <table border="0" cellspacing="0" cellpadding="8" class="salient_geophy_wm4d_table_support">
        <thead>
            <th>Slide / Section</th>
    ...
    <h3>&nbsp;</h3>
    <h3>Salient Geophy Theme Support</h3>
    <hr />
    ...
    <p>Child theme for the Salient theme. Integrated with WM4D-Options.</p>
